...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      { id: "forum", label: "Forum", href: "/latest", dot: true },
      { id: "challenge", label: "Challenge", href: "/c/challenge", dot: true },
      { id: "members", label: "All Members", href: "/u" },
    ],
  },
  {
    id: "konten",
    label: "Konten Eksklusif",
    href: "/c/konten-eksklusif",
  ...
  },
  {
    ...
    children: [
      { id: "trainer", label: "Materi Trainer Utama", href: "/c/materi-trainer-utama" },
      { id: "permainan", label: "Permainan di Pelatihan", href: "/c/permainan", dot: true },
      { id: "musik", label: "Musik Gasing", href: "/c/musik-gasing" },
      { id: "minigames", label: "Mini Games", href: "/c/mini-games" },
      { id: "thinkplay", label: "Gasing Think & Play", href: "/c/think-and-play" },
    ],
  },
];
...
export default class GasingSidebar extends Component {
  ...
  constructor() {
    ...
    NAV_ITEMS.forEach((item) => {
      if (item.children) {
        const match = item.children.some((c) => c.href && path.startsWith(c.href));
